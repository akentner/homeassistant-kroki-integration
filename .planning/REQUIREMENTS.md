...
- [x] **PANEL-01**: Kroki-Sidebar-Panel ist in HA registriert und über die Seitenleiste erreichbar
...
- [x] **PANEL-04**: Panel rendert bei Änderungen eine Live-Vorschau via Kroki-Server (WebSocket-Backend)
